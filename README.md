...
To skip the key prompt: `npx vugola-mcp@1.1.2 install --key vug_sk_yourkey`.

### Claude Code

```bash
claude mcp add vugola -- npx -y vugola-mcp@1.1.2
```
